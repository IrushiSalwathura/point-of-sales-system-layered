...
//
    ...
    public void btnPlaceOrder_OnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean result = orderBO.placeOrder(new OrderTM(lblOrdeID.getText(), java.sql.Date.valueOf(LocalDate.now()), cmbCustomerID.getValue().getCustomerId(), cmbCustomerID.getValue().getCustomerName(), BigDecimal.ZERO), tblOrders.getItems());
            if (!result) {
