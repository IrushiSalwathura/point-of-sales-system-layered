    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        try {
            if (btnSave.getText().equals("SAVE")) {
                ...
                CustomerTM selectedItem = tblCustomers.getSelectionModel().getSelectedItem();
                boolean result = customerBO.updateCustomer(txtCustomerName.getText(), txtAddress.getText(), selectedItem.getCustomerId());
                if (!result) {
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (buttonType.get() == ButtonType.YES) {
                ...
                boolean result = customerBO.deleteCustomer(selectedItem.getCustomerId());
                if (!result) {
