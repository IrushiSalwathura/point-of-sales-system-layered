    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        try {
            if (btnSave.getText().equals("SAVE")) {
                ...
                boolean result = itemBO.saveItem(txtItemCode.getText(), txtDescription.getText(), unitPrice, qtyOnHand);
                if (!result) {
                ...
                boolean result = itemBO.updateItem(txtDescription.getText(), unitPrice, qtyOnHand, selectedItem.getItemCode());
                if (!result) {
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (buttonType.get() == ButtonType.YES) {
                ItemTM selectedItem = tblItems.getSelectionModel().getSelectedItem();
                boolean result = itemBO.deleteItem(selectedItem.getItemCode());
                if (!result) {
